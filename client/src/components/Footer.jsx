        ...
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              Laundry services cater to individuals who seek a time-saving and convenient solution for maintaining clean and well-cared-for clothing without the hassle of doing it themselves.
              </p>
          ...
          <p className="text-xs text-gray-500">&copy; 2023. CoolKlean Laundry Shop. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
